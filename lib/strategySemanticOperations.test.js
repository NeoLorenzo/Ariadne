...
describe("strategy semantic operation orchestration", () => {
  ...
  it("uses the checked direction semantic RPC with a stable revision id and baseline", async () => {
    const direction = {
      id: "direction-1", title: "Old", statement: "Old statement", updatedAt: "2026-09-06T10:00:00.000Z"
    };
    await updateDirection({ direction, revisions: [], title: "New", statement: "New statement",
      changeReason: "Refined direction", userId: "user-1" });
