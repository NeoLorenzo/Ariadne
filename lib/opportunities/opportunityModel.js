...
export function normalizeOpportunity(input = {}) {
  ...
  if (hasStructuredRequirements || hasMiscRequirements) {
    normalized.standardizedRequirements = normalizeStandardizedRequirements(input.standardizedRequirements ?? input.standardized_requirements);
    normalized.miscRequirements = miscRequirements;
  }
  return normalized;
}
