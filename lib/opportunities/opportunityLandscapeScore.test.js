...
import {
  OPPORTUNITY_LANDSCAPE_HIGH_THRESHOLD,
...
describe("opportunity landscape scoring", () => {
  it("uses 75 as the canonical high-value/high-attainability threshold", () => {
    expect(OPPORTUNITY_LANDSCAPE_HIGH_THRESHOLD).toBe(75);
  });
