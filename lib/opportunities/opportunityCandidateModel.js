...
export function isOpportunityCandidateDescriptionExcerpt(input = {}) { const payload = normalizeSourcePayload(input.sourcePayload ?? input.source_payload); return payload.description_is_excerpt === true || normalizeKey(payload.description_completeness) === "excerpt"; }
