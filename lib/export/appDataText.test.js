...
describe("multidirectional strategy export", () => {
  ...
  it("exports all concurrent directions and their strategic objectives without an Outcome Goal layer", () => {
    const text = formatDirections({
      ...
      "direction-a": [{
        ...
        description: "Demonstrate serious technical work",
        successCondition: "Credible public technical artifacts exist",
        status: "active",
        position: 0
      }],
      "direction-b": []
    ...
    expect(text).toContain("##### 1. Build technical credibility");
    expect(text).not.toContain("Outcome Goals");
  });
});
