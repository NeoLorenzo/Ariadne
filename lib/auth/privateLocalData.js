...
const PRIVATE_LOCAL_STORAGE_KEYS = [
  ...
  "fabbro_projects_v1",
  "fabbro_direction_v1",
  "ariadne_directions_v2",
  "fabbro_strategic_objectives_v1",
  "fabbro_outcome_goals_v1",
  "fabbro_outcome_goal_revisions_v1",
  "ariadne_strategy_pending_v1",
  "ariadne_strategy_sync_bases_v1",
  "ariadne_opportunities_v1",
  "ariadne_opportunity_pending_v1",
  "ariadne_opportunity_candidates_v1",
  "ariadne_opportunity_applications_v1",
