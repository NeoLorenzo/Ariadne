...
export default function OpportunityEditor({
  ...
  const submit = async (event) => {
    ...
    if (!accepted) {
      setErrors((current) => ({ ...current, general: "The opportunity could not be saved." }));
    }
  };
      ...
      <ModalShell ref={dialogRef} as="form" className={styles.editor} onSubmit={submit}>
        ...
        <ModalBody className={styles.editorBody}>
          <div className={styles.editorGrid}>
            ...
            <div className={styles.fieldFull}>
              <label htmlFor="opportunity-requirements">Requirements / eligibility</label>
              <TextArea
                ...
                placeholder="Eligibility, prerequisites, documents, experience…"
              />
            </div>
            ...
            <div className={styles.fieldFull}>
              ...
              <TextArea
                ...
                placeholder="Why it matters, useful context, application notes…"
              />
            </div>
          </div>
        ...
        <ModalFooter className={styles.editorFooter}>
          {isEditing ? (
            <>
              <GhostButton type="button" onClick={() => onArchiveToggle(opportunity)} disabled={isBusy}>
                {opportunity.archived ? "Restore" : "Archive"}
              </GhostButton>
              <GhostButton type="button" className={styles.dangerButton} onClick={requestDelete} disabled={isBusy}>
                Delete
              </GhostButton>
            </>
          ) : null}
