...
create policy "Authorized user can read goat scores"
on public.goat_score_entries
for select
to authenticated
...
create policy "Authorized user can write goat scores"
on public.goat_score_entries
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat lifts"
on public.goat_strength_lifts
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat lifts" on public.goat_strength_lifts;
create policy "Authorized user can write goat lifts"
on public.goat_strength_lifts
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat cognitive tests"
on public.goat_cognitive_tests
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat cognitive tests" on public.goat_cognitive_tests;
create policy "Authorized user can write goat cognitive tests"
on public.goat_cognitive_tests
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat academic stages"
on public.goat_academic_stage_results
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat academic stages" on public.goat_academic_stage_results;
create policy "Authorized user can write goat academic stages"
on public.goat_academic_stage_results
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat academic modules"
on public.goat_academic_module_results
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat academic modules" on public.goat_academic_module_results;
create policy "Authorized user can write goat academic modules"
on public.goat_academic_module_results
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat misc"
...
create policy "Authorized user can read goat cv"
on public.goat_cv_characteristics
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat cv" on public.goat_cv_characteristics;
create policy "Authorized user can write goat cv"
on public.goat_cv_characteristics
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat immutable"
on public.goat_immutable_characteristics
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat immutable" on public.goat_immutable_characteristics;
create policy "Authorized user can write goat immutable"
on public.goat_immutable_characteristics
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat academic notes"
on public.goat_academic_notes
for select
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com');

drop policy if exists "Authorized user can write goat academic notes" on public.goat_academic_notes;
create policy "Authorized user can write goat academic notes"
on public.goat_academic_notes
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
...
create policy "Authorized user can read goat strength profile"
...
create policy "Authorized user can write goat strength profile"
on public.goat_strength_profile
for all
to authenticated
using (auth.uid() = user_id and lower(coalesce(auth.jwt()->>'email', '')) = 'theneolorenzo@gmail.com')
