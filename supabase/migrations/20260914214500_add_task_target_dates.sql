-- Add a planning-only targetDate field to the ChatGPT task control surface.
-- dueDate/dueTime remain real deadline fields; targetDate is a movable completion target.
...
begin
  ...
  where key not in ('title','description','priority','dueDate','targetDate','dueTime','tags','estimatedHours','completed','deleted')
  limit 1;
